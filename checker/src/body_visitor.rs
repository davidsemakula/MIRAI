...
pub struct BodyVisitor<'analysis, 'compilation, 'tcx> {
    ...
    pub already_reported_errors_for_span: HashSet<(MultiSpan, DiagnosticMessage)>,
...
impl<'analysis, 'compilation, 'tcx> BodyVisitor<'analysis, 'compilation, 'tcx> {
    ...
    pub fn new(
        ...
        BodyVisitor {
            ...
            already_reported_errors_for_span: HashSet::new(),
    ...
    pub fn emit_diagnostic(&mut self, diagnostic_builder: DiagnosticBuilder<'compilation, ()>) {
        ...
        // Deduplicate diagnostics by span and message combination.
        let diagnostic_span_message = (
            diagnostic_builder.span.clone(),
            diagnostic_builder.messages[0].0.clone(),
        );
        if self
            .already_reported_errors_for_span
        ...
        self.already_reported_errors_for_span
